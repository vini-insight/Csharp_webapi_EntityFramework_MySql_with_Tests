# Csharp_webapi_EntityFramework_MySql_with_Tests
...
na raíz do projeto Csharp_webapi_EntityFramework_MySql,
...
altere OU crie o arquivos appsettings.json para:

    {
        ...
        "ConnectionStrings": {
            "myConnection": "Server=IP-or-DNS;Port=PORT-NUMBER;Database=DB-NAME;Uid=USER-NAME;Pwd=PASS-WORD;charset=utf8;"
            },
        "AllowedHosts": "*"
    }
...
e também na pasta Data altere a classe DataContext.cs:
